        ...
        {!isConnected ? (
          <div className="text-center py-20">
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              A simple deal rail for humans and agents: negotiate, confirm, escrow, and settle with onchain proofs.
            </p>
            <div className="max-w-2xl mx-auto mb-8 grid grid-cols-1 md:grid-cols-3 gap-3 text-left">
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <div className="text-xs text-gray-400 mb-1">Step 1</div>
                <div className="font-semibold text-gray-100">Set policy</div>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <div className="text-xs text-gray-400 mb-1">Step 2</div>
                <div className="font-semibold text-gray-100">Run agent deal flow</div>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <div className="text-xs text-gray-400 mb-1">Step 3</div>
                <div className="font-semibold text-gray-100">Track settlement</div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 space-y-3">
              <div className="text-sm text-gray-300">Choose workspace mode</div>
            ...
            {viewMode === 'human' ? (
              <div className="space-y-6">
                <section className="space-y-2">
                  <h2 className="text-lg font-semibold text-white">1. Run Deal Flow</h2>
                  <p className="text-sm text-gray-400">
                    Set policy, run reverse-auction negotiation, confirm a deal, then track onchain settlement.
                  </p>
                  <DealPipelineDashboard />
                </section>

                <section className="space-y-2">
                  <h2 className="text-lg font-semibold text-white">2. Manage Jobs</h2>
                  <p className="text-sm text-gray-400">
                    Review existing jobs and lifecycle state.
                  </p>
                  <JobsList address={address} />
                </section>

                <details className="bg-gray-800/40 border border-gray-700 rounded-lg p-4">
                  <summary className="cursor-pointer text-sm text-gray-300">Advanced discovery and integrations</summary>
              ...
              <div className="space-y-6">
                <section className="space-y-2">
                  <h2 className="text-lg font-semibold text-white">Agent Discovery + Negotiation Inputs</h2>
                  <p className="text-sm text-gray-400">
                    Select counterparties, check identity signals, and feed addresses into the pipeline.
                  </p>
                  <ProviderDiscoveryPanel />
                </section>

                <section className="space-y-2">
                  <h2 className="text-lg font-semibold text-white">Agent Tooling Workbench</h2>
                  <p className="text-sm text-gray-400">
                    Build and execute adapter payloads (Uniswap, Locus, Delegation, x402).
                  </p>
                  <IntegrationsWorkbench />
                </section>

                <section className="space-y-2">
                  <h2 className="text-lg font-semibold text-white">Onchain Job State</h2>
                  <JobsList address={address} />
                </section>
              </div>
            )}
